...
struct DefaultAIChatService: AIChatService {
    ...
    private func activityLabel(for tool: String) -> String {
        ...
        case "list_watchlist": "Reading your watchlist…"
        case "upsert_watchlist_item": "Updating your watchlist…"
        case "remove_watchlist_item": "Removing a watchlist entry…"
        case "add_position": "Recording the position…"
        case "sell_position": "Recording the sale…"
        case "delete_position": "Deleting the position record…"
        case "list_transactions": "Reading your recorded trades…"
        case "record_trade": "Recording the trade…"
        case "delete_trade": "Deleting the trade record…"
        case "list_goals": "Reading your goals…"
        case "add_goal": "Adding the goal…"
        case "update_goal": "Renaming the goal…"
        case "delete_goal": "Deleting the goal…"
