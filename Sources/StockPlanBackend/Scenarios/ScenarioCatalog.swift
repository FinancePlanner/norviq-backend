...
enum ScenarioCatalog {
    ...
    static let response = ScenarioCatalogResponse(version: version, historicalScenarios: [
        ...
        // Tech-heavy 2022 drawdown window (Nasdaq / growth factor proxy via per-holding history).
        .init(id: "tech_2022", name: "Tech 2022 drawdown", startDate: "2022-01-03", endDate: "2022-10-14"),
    ])
}
